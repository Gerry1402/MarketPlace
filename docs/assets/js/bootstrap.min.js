                    ...
                    return (
                        ...
                        (d.show = function () {
                            ...
                            if (!this._isTransitioning && !e(this._element).hasClass(h.SHOW)) {
                                ...
                                if (
                                    (this._parent &&
                                        ((r = e.makeArray(e(this._parent).children().children(u.ACTIVES)))
                                            .length ||
                                            (r = null)),
                ...
                g = (function () {
                    ...
                    return (
                        ...
                        (g._getConfig = function (n) {
                            return (
                                (n = e.extend({}, this.constructor.Default, e(this._element).data(), n)),
                        ...
                        (g._getPlacement = function () {
                            ...
                            return (
                                t.hasClass(c.DROPUP)
                                    ? ((n = d.TOP), e(this._menu).hasClass(c.MENURIGHT) && (n = d.TOPEND))
                        ...
                        (g._getPopperConfig = function () {
                            ...
                            return (
                                this._inNavbar && (i.modifiers.applyStyle = { enabled: !this._inNavbar }), i
                            );
                        }),
                        ...
                        (u._showBackdrop = function (t) {
                            ...
                            if (this._isShown && this._config.backdrop) {
                                ...
                                s.supportsTransitionEnd() && e(this._element).hasClass(h.FADE)
                                    ? e(this._backdrop).one(s.TRANSITION_END, o).emulateTransitionEnd(150)
                                    : o();
                            } else t && t();
                        }),
                    ...
                    return (
                        ...
                        (u._activate = function (t) {
                            ...
                            i.hasClass(l.DROPDOWN_ITEM)
                                ? (i.closest(h.DROPDOWN).find(h.DROPDOWN_TOGGLE).addClass(l.ACTIVE),
                                  i.addClass(l.ACTIVE))
                                : (i.addClass(l.ACTIVE),
                                  i
                    ...
                    return (
                        ...
                        (a._transitionComplete = function (t, n, r, a) {
                            ...
                            if (
                                ...
                                r ? (s.reflow(t), e(t).addClass(i.SHOW)) : e(t).removeClass(i.FADE),
