    ...
    var e = (function (n) {
        ...
        function t(i) {
            var t = this,
                s = !1;
            return (
                n(this).one(e.TRANSITION_END, function () {
                    s = !0;
                }),
                setTimeout(function () {
        ...
        return (
            ...
            (n.fn.mmEmulateTransitionEnd = t),
            e.supportsTransitionEnd() &&
                (n.event.special[e.TRANSITION_END] = {
                    bindType: i.end,
                    delegateType: i.end,
                    handle: function (i) {
                ...
                return (
                            ...
                            n(this._element)
                                ...
                                .on(l.CLICK_DATA_API, function (t) {
                                    var e = n(this),
                                        ...
                                        o = s
                                            .siblings(i._config.parentTrigger)
                                            .children(i._config.triggerElement),
                                        a = s.children(i._config.subMenu);
                                    i._config.preventDefault && t.preventDefault(),
                                        'true' !== e.attr('aria-disabled') &&
                                            (s.hasClass(i._config.activeClass)
                                                ? (e.attr('aria-expanded', !1), i._hide(a))
                                                : (i._show(a),
                    ...
                    (i.prototype._show = function (i) {
                        if (!this._transitioning && !n(i).hasClass(this._config.collapsingClass)) {
                            ...
                            if ((s.trigger(o), !o.isDefaultPrevented())) {
                                s.parent(this._config.parentTrigger).addClass(this._config.activeClass),
                                    this._config.toggle &&
                                        this._hide(
                                            s
                    ...
                    (i.prototype._hide = function (i) {
                        if (!this._transitioning && n(i).hasClass(this._config.collapseInClass)) {
                            var t = this,
                                ...
                                o = n.Event(l.HIDE);
                            if ((s.trigger(o), !o.isDefaultPrevented())) {
                                s.parent(this._config.parentTrigger).removeClass(this._config.activeClass),
                                ...
                                e.supportsTransitionEnd()
                                    ? 0 == s.height() || 'none' == s.css('display')
                                        ? a()
                                        : s.height(0).one(e.TRANSITION_END, a).mmEmulateTransitionEnd(350)
                                    : a();
                            }
                        }
                    }),
                    ...
                    (i._jQueryInterface = function (e) {
                        return this.each(function () {
                            ...
                            if (
                                (!a && /dispose/.test(e) && this.dispose(),
                                a || ((a = new i(this, l)), o.data(s, a)),
                                'string' == typeof e)
                            ) {
