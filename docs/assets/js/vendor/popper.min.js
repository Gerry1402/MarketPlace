 ...
 */ (function (e, t) {
    ...
    function H(e, t, o, i) {
        ...
        var r = n(e);
        return (
            D(r, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = r), (o.eventsEnabled = !0), o
        );
    }
    function A() {
    ...
    function I() {
        this.state.eventsEnabled &&
            (window.cancelAnimationFrame(this.scheduleUpdate), (this.state = M(this.reference, this.state)));
    }
    function R(e) {
                        ...
                        var n = t.priority,
                            ...
                            s = {
                                primary: function (e) {
                                    var o = p[e];
                                    return (
                                        p[e] < i[e] && !t.escapeWithReference && (o = X(p[e], i[e])),
                                        se({}, e, o)
                                    );
                                },
