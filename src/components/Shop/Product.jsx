                    ...
                    <div className="row ">
                        ...
                        <div className="col-lg-6">
                            <div className="shop-product-details-content pl-70 mt-35">
                                ...
                                <p>
                                    So I said nancy boy he lost his bottle smashing mush brolly victoria
                                    sponge loo, bobby say Charles gutted mate bugger fanny around, lurgy grub
                                    some dodgy chav blatant blag me old mucker.
                                </p>
                                ...
                                <ul className="nav nav-pills mb-35" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <a
                                            ...
                                            className={`nav-link ${detailsTab === 'des' ? 'active' : ''}`}
                                            id="pills-home-tab"
                                            data-toggle="pill"
                                            href="#pills-home"
                                            role="tab"
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <a
                                            ...
                                            className={`nav-link ${detailsTab === 'review' ? 'active' : ''}`}
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="appie-section-title text-center">
                                ...
                                <p>So I said knees up cuppa such a fibber jeffrey a bit of how's your.</p>
                            </div>
                        </div>
                    </div>
