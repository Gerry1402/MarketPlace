        ...
        <>
            <div className="single-post-area">
                ...
                <div className="post-admin">
                    ...
                    <p>
                        Me old mucker bits and bobs you mug tickety-boo a load
                        of old tosh bender mufty bloke old daft.
                    </p>
                </div>
            </div>
                    ...
                    <li>
                        <div className="single-comment">
                            ...
                            <div className="comment">
                                <p>
                                    He legged it bevvy mush owt to do with me
                                    such fibber fa about cup of tea sloshed
                                    morish butty bubble. Butty gormless lavatory
                                    twit bits and bobs pardon you daft ummm I'm
                                    telling.
                                </p>
                            </div>
                        ...
                        <ul className="children">
                            <li>
                                <div className="single-comment">
                                    ...
                                    <div className="comment">
                                        <p>
                                            Super chancer cheeky bloke haggle
                                            give us a bell well mufty chinwag
                                            say bite. lavatory twit bits and
                                            bobs pardon you daft ummm I'm
                                            telling. Blatant matie boy say
                            ...
                            <li>
                                <div className="single-comment">
                                    ...
                                    <div className="comment">
                                        <p>
                                            Oxford baking cakes dropped clanger
                                            fanny around vagabond amongst cor
                                            blimey guvnor. Blatant matie boy say
                                            bugger all mate butty gormless
                                            lavatory twit bits and bobs pardon
                                            you daft ummm I'm telling.
                                        </p>
                                    </div>
                                    <a className="comment-reply-link" href="#">
                                        <i className="fal fa-reply"></i>Reply
