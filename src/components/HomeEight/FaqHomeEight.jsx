                        ...
                        <div className="col-lg-5">
                            ...
                            <div className="faq-accordion wow fadeInRight mt-30" data-wow-duration="1500ms">
                                <div
                                    ...
                                    <div
                                        className={`accrodion ${showQuestion === 0 ? 'active' : ''}`}
                                            ...
                                            <div
                                                ...
                                                <div className="inner">
                                                    <p>
                                                        ...
                                                        tomfoolery that I bits and bobs up the cras boot.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        className={`accrodion ${showQuestion === 1 ? 'active' : ''}`}
                                    ...
                                    <div
                                        className={`accrodion ${showQuestion === 2 ? 'active' : ''}`}
