...
const HomeDark = () => {
    ...
    return (
        <>
            ...
            <ServicesHomeOne
                className={darkMode ? "appie-service-area-dark" : ""}
            />
            <FeaturesHomeOne
                className={darkMode ? "appie-features-area-dark" : ""}
            />
            <TrafficHomeOne
                className={darkMode ? "appie-traffic-area-dark" : ""}
            />
            <TestimonialHomeOne />
            <TeamHomeOne className={darkMode ? "appie-team-area-dark" : ""} />
            <PricingHomeOne
                className={darkMode ? "appie-pricing-area-dark" : ""}
            />
