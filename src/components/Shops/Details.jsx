                    ...
                    <div className="row ">
                        ...
                        <div className="col-lg-6">
                            <div className="shop-product-details-content pl-70 mt-35">
                                ...
                                <p>
                                    So I said nancy boy he lost his bottle
                                    smashing mush brolly victoria sponge loo,
                                    bobby say Charles gutted mate bugger fanny
                                    around, lurgy grub some dodgy chav blatant
                                    blag me old mucker.
                                </p>
                                ...
                                <div className="details-info">
                                    <ul>
                                        ...
                                        <li>
                                            <span>Categories: </span> Watch,
                                            Appie, UX
                                        </li>
                                        <li>
                                            <span>Tags:</span> Creative, Shop,
                                            WordPress
                                        </li>
                                    </ul>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className="shop-description">
                                            <p>
                                                Uninhibited carnally hired
                                                played in whimpered dear gorilla
                                                koala depending and much yikes
                                                off far quetzal goodness and
                                                from for grimaced goodness
                                                unaccountably and meadowlark
                                                near unblushingly crucial
                                                scallop tightly neurotic
                                                hungrily some and dear furiously
                                                this apart. Spluttered narrowly
                                                yikes left moth in yikes bowed
                                                this that grizzly much hello on
                                                spoon-fed that alas rethought
                                                much decently richly and wow
                                                against the frequent fluidly at
                                            ...
                                            <p>
                                                Laconic overheard dear woodchuck
                                            ...
                                            <div className="top-rating-result">
                                                ...
                                                <div className="rating-result-box">
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <p>
                                                            That arse over tit a
                                                            load of old tosh
                                                            pardon you wellies
                                                            amongst william my
                                                            good sir grub your
                                                            bike mate james bond
                                                            morish a blinding.
                                                        </p>
                                                    </div>
                                                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="appie-section-title text-center">
                                ...
                                <p>
                                    So I said knees up cuppa such a fibber
                                    jeffrey a bit of how's your.
                                </p>
                            </div>
                        </div>
                    </div>
