// src/components/Shops/Backpack.jsx
              ...
              <div className="card p-3">
                <div className="form-row">
                  ...
                  <div className="col-md-3 mb-3">
                    ...
                    <input
                      name="weight" type="number" step="0.01"
                      className="form-control"
                      value={form.weight}
                      onChange={handleChange}
                    />
                  ...
                  <div className="col-md-3 mb-3">
                    ...
                    <select
                      name="categories_id" className="form-control"
                  ...
                  <div className="col-md-3 mb-3">
                    <label>Size</label>
                    <select
                      name="size_id" className="form-control"
                      value={form.size_id}
                      onChange={handleChange}
                    >
                      {sizes.map((s) => (
                  ...
                  <div className="col-md-3 mb-3">  
                    <label>Color</label>
                    <select
                      name="color_id" className="form-control"
                      value={form.color_id}
                      onChange={handleChange}
                    >
                      {colors.map((c) => (
                  ...
                  <div className="col-md-3 mb-3">
                    <label>Shop</label>
                    <select
                      name="shop_id" className="form-control"
                      value={form.shop_id}
                      onChange={handleChange}
                    >
                    ...
                    sellItems.map((item) => (
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <i
                            className={`fas fa-chevron-${expandedId === item.id ? "up" : "down"}`}
                          />
                        </div>
                        {expandedId === item.id && (
                          <div className="mt-3 p-3" style={{ background: "#f8f9fa", width: "100%" }}>
                            <div className="d-flex">
                              ...
                              <div style={{ flex: "0 0 200px", textAlign: "left" }}>
                                ...
                                <div style={{ fontSize: "0.9rem", color: "#555" }}>
                                  ...
                                  <p className="mb-1">
                                    <strong>Category:</strong> {findName(categories, item.categories_id)}
                                  </p>
                                  <p className="mb-0">
                                    <strong>Shop:</strong> {findName(shops, item.shop_id)}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div style={{ flex: 1, paddingLeft: "20px" }}>
                                ...
                                <p><strong>Size:</strong> {findName(sizes, item.size_id)}</p>
                                <p><strong>Color:</strong> {findName(colors, item.color_id)}</p>

                                {/* Stock controls */}
                                <div className="d-flex my-3">
                                  <button
                                    className="btn btn-primary mr-2 flex-fill"
                                    onClick={(e) => { e.stopPropagation(); updateStock(item, -1); }}
                                  >
                                    Decrease Stock –
                                  </button>
                                  <button
                                ...
                                <button
                                  ...
                                  onClick={(e) => { e.stopPropagation(); deleteProduct(item); }}
                                >
                                  Delete Item
                                </button>
                              </div>
