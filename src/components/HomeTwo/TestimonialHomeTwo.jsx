...
const TestimonialHomeTwo = () => {
    ...
    return (
        <>
            <section
                className="appie-testimonial-2-area mb-90"
                id="testimonial"
            >
                                            ...
                                            <div className="item">
                                                ...
                                                <div className="content">
                                                    <p>
                                                        ...
                                                        is spiffing chip shop
                                                        such a fibber the bee's
                                                        knees, the wireless
                                                        Richard fantastic do one
                                                        cracking goal pukka
                                                        baking cakes starkers
                                                        mush don't get shirty
                                                        with me argy bargy, I
                                                        naff chimney pot blimey
                                                        he lost his bottle cup.
                                                    </p>
